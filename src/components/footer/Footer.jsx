...
const Footer = () => {
  ...
  return (
    <footer className="footer-goyanava">
      <div className="footer-container">
        ...
        <div className="footer-grid">
          ...
          <div className="footer-column footer-brand">
            ...
            <p className="footer-description">
              Conectamos profesionales, emprendedores, negocios con clientes en Goya, Corrientes. 
              Una plataforma local, gratuita y sin comisiones.
            </p>
            <div className="footer-social">
              ...
              >
                <svg viewBox="0 0 24 24" className="footer-social-icon">
          ...
          <div className="footer-column footer-contact-desktop">
            <h4 className="footer-title">Contacto</h4>
            <ul className="footer-contact">
              <li>
                <span className="material-icons">location_on</span>
                <span>Goya, Corrientes</span>
              </li>
              <li>
                <span className="material-icons">email</span>
                <a href="mailto:goyanovasoporte@gmail.com">goyanovasoporte@gmail.com</a>
              </li>
              <li>
                <span className="material-icons">phone</span>
                <a href="https://wa.me/5493777716363">+54 3777 71-6363</a>
              </li>
            </ul>
          </div>
        ...
        <div className="footer-bottom">
          <p className="footer-copyright">
            &copy; {currentYear} GoyaNova. Todos los derechos reservados.
          </p>
          <p className="footer-credit">
            Hecho con <span className="material-icons footer-heart">favorite</span> en Goya
          </p>
        </div>
